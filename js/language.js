document.addEventListener('DOMContentLoaded', function() {
    ...
    const translations = {
        'az': {
            ...
            'title_contact' : "Piral Kəndi - Əlaqə",
            'menu_home' : "Ana Səhifə",
            'menu_about' : "Haqqında",
            'menu_news' : "Xəbərlər",
            'menu_people' : "Tanınmışlar",
            'menu_contact' : "Əlaqə",
            'menu_admin' : "Admin",
            'contact_title' : "Adminlə Əlaqə",
            'btn_message' : "Mesaj Yazın",
            'idea_title' : "Sayt haqqında fikriniz varmı?",
            'idea_text' : "Əgər sizin də sayt haqqında bir ideyanız və ya təklifiniz varsa, bizimlə paylaşın!",
            'placeholder_name' : "Adınız",
            'placeholder_email' : "Email ünvanınız",
            ...
            'menu_other' : 'Digər...',
            "title_channels": "Sosial Media Kanalları",
            "channel_section_title": "Kəndimiz haqqında maraqlı paylaşım edən kanallar",
            "link_channels": "Kəndimiz haqqında maraqlı paylaşım edən kanallar",
            "back_button": "Geri Qayıt",
        ...
        'en': {
            ...
            'title_contact' : "Piral Village - Contact",
            'menu_home' : "Home",
            'menu_about' : "About",
            'menu_news' : "News",
            'menu_people' : "Celebrities",
            'menu_contact' : "Contact",
            'menu_admin' : "Admin",
            'contact_title' : "Contact the Admin",
            'btn_message' : "Send Message",
            'idea_title' : "Have an idea about the site?",
            'idea_text' : "If you have any suggestions or ideas about the site, feel free to share!",
            ...
            'menu_other' : 'Other...',
            "title_channels": "Social Media Channels",
            "channel_section_title": "Interesting channels about our village",
            "link_channels": "Interesting channels about our village",
            "back_button": "Go Back",
        ...
        'ru': {
            ...
            'title_contact' : "Село Пирал - Контакт",
            'menu_home' : "Главная",
            'menu_about' : "О нас",
            'menu_news' : "Новости",
            'menu_people' : "Знаменитости",
            ...
            'menu_admin' : "Админ",
            'contact_title' : "Связь с админом",
            'btn_message' : "Написать",
            'idea_title' : "Есть идея о сайте?",
            'idea_text' : "Если у вас есть предложения или идеи по сайту, поделитесь с нами!",
            ...
            'menu_other' : 'Другой...',
            "title_channels": "Социальные каналы",
            "channel_section_title": "Интересные каналы о нашем селе",
            "link_channels": "Интересные каналы о нашем селе",
            "back_button": "Назад",
